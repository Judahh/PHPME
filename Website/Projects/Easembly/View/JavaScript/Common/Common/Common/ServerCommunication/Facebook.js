...
//        $("#DivLogoutText").show();
//    }
//    //$("#DivLogoutText").toggle(facebookID!=null);
//    //$("#DivLoginText").toggle(facebookID==null);
//}

function logged(){
    //alert('Logged!');
    $("#DivLoginText").toggle(false);
    $("#DivLogoutText").toggle(true);
    getProfilePicture();
...
function facebookLoginThenGoToPage(window){
...
function LoginAndGoToPage(window) {
    FB.getLoginStatus(function(response) {
        if (response.status === 'connected') {
            goToPage(window);
        } else {
            facebookLoginThenGoToPage(window);
        }
    });
