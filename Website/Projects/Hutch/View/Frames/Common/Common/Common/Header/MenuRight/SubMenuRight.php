...
<!--    </li>-->
                        ...
                        <div id="DivIdPointerCursor" onclick="goToPage('Home')">
                            <div id="DivIdNeon">
                                <div id="DivIdTextBasic">
                                    <?php
                                        $multilingualText = MultilingualText::MultilingualText();
                                        echo $multilingualText->getMultilingualTextFromWindowFromCommon($language, "MenuRight", "food");
                                    ?>
                                </div>
                            </div>
                        </div>
    ...
    <li>
        <div id="DivIdNeon" onclick="facebookLogInOut()">
            <div id="DivIdMenuItem">
                <div id="DivIdIcon" style="color: #ffffff"><div id="DivIdPulse"><div id="DivIdProfilePicture">0</div></div></div>
            </div>
        </div>
        <div id="DivIdSubMenuUser">
            <ul>
                ...
                <div id="DivIdSubMenuUserHolder2">
                        ...
                        <div id="DivIdPointerCursor" onclick="homeSmoothScroll('DivIdMyOrders')">
                            <div id="DivIdNeon">
                                <div id="DivIdTextBasic">
                                    <?php
                                        $multilingualText = MultilingualText::MultilingualText();
                                        echo $multilingualText->getMultilingualTextFromWindowFromCommon($language, "MenuRight", "myOrders");
                                    ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        <div id="DivIdPointerCursor" onclick="homeSmoothScroll('DivIdOrderNow')">
                            <div id="DivIdNeon">
                                <div id="DivIdTextBasic">
                                    <?php
                                        $multilingualText = MultilingualText::MultilingualText();
                                        echo $multilingualText->getMultilingualTextFromWindowFromCommon($language, "MenuRight", "orderNow");
                                    ?>
                                </div>
                            </div>
                        </div>
