                    ...
                    <div id="DivIdTextBasic">
                        ...
                        <div id="DivFullBlock">
                            <div id="DivIdTextJustified" style="color: #ffffff">
                                <?php
                                    echo $multilingualText->getMultilingualTextFromWindowFromCommon($language , "Home", "restaurant");
                                ?>
                            </div>
                            <div id="DivIdSomeOpacity">
                                <div id="DivIdRestaurantForm">
                                    <form id="FormIdRestaurant" name="RestaurantForm"> <!--action="form.html"!-->
                                        <div>
                                            ...
                                            echo $multilingualText->getMultilingualTextFromWindowFromCommon($language , "Home", "restaurantName");
                                            ?>" />
                                        </div>
                                        <div>
                                    ...
                                    <form id="FormIdLocation" name="LocationForm"> <!--action="form.html"!-->
                                        <div class="DivClassComboBoxEditable" autocomplete='off'>
                                            ...
                                            <div class="DivClassDropDownList">
                                                ...
                                                <a><?php echo $multilingualText->getMultilingualTextFromWindowFromCommon($language , "Home", "newAddress");?></a>
                                                <a>Ex1</a>
                                                <a>Ex2</a>
                                            </div>
                                        </div>
                                        <div>
                                            <textarea id="TextAreaIdMainLocationAddress" name="MainLocationAddress" class="ClassMainLocationAddressValidator" onchange="simpleAddressValidator('TextAreaIdMainLocationAddress')" placeholder="<?php
                                            echo $multilingualText->getMultilingualTextFromWindowFromCommon($language , "Home", "mainLocationAddress");
                                            ?>"></textarea>
<!--                                            <div id="DivIdValidAddress">-->
<!--                                                -->
<!--                                            </div>-->
                                        </div>
                                        <div>
